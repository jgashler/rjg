...
class Ear(rModule.RigModule, rFk.Fk):
    ...
    def add_plugs(self):
        rAttr.Attribute(node=self.part_grp, type='plug', value=['neck_M_03_JNT'], name='skeletonPlugs', children_name=[self.bind_joints[0]])

        driver_list = ['head_M_01_CTRL']
