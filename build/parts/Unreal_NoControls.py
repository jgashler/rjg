...
class Unreal_Correctives2(rModule.RigModule):
    ...
    def control_rig(self):
        ...
        #    self.corr_ctrl = rCtrl.Control(parent=self.control_grp, shape='circle', side=self.side, suffix='CTRL', name=guide, axis='z', group_type='main', rig_type='primary', translate=(mc.xform(guide, q=True, ws=True, t=True)), rotate=guide, ctrl_scale=self.ctrl_scale)
