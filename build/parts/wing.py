...
class Wing(rModule.RigModule, rIk.Ik, rFk.Fk):
    def __init__(self,side=None,part=None,guide_list=None, ctrl_scale=1,create_ik=True,create_fk=True,stretchy=True,twisty=True,bendy=True,segments=4,
        ...
        super(Wing, self).__init__(side=side, part=part, guide_list=guide_list, ctrl_scale=ctrl_scale, model_path=model_path, guide_path=guide_path)
    ...
    def add_plugs(self):
        ...
        if self.part == 'leg':
            ...
            par = 'scapula_' + self.side + '_02_JNT'
            driver_list = ['scapula_' + self.side + '_02_driver_JNT',
                           'scapula_' + self.side + '_02_driver_JNT',
                           'scapula_' + self.side + '_02_driver_JNT',
            ...
            rAttr.Attribute(node=self.part_grp, type='plug', value=['scapula_' + self.side + '_02_driver_JNT'], name='pocRigPlugs', children_name=['wing_' + self.side + '_01_fk_CTRL_CNST_GRP'])
            target_list = ['ROOT', 'global_M_CTRL', 'root_02_M_CTRL', 'chest_M_01_CTRL', 'chest_M_02_CTRL', 'scapula_' + self.side + '_02_driver_JNT', '3']
            name_list = ['world', 'global', 'root', 'chest01', 'chest02', 'scapula', 'default_value']
            orient_names = ['orient' + name.title() for name in name_list]
            rAttr.Attribute(node=self.part_grp, type='plug', value=target_list, name=self.fk_ctrls[0].ctrl + '_orient', children_name=orient_names)
