...
mp = '/groups/dungeons/character/Rigging/Robin/robin_model.mb'
gp = '/groups/dungeons/character/Rigging/Robin/robin_guides.mb'
pref = ''
...
rFile.import_hierarchy('/groups/dungeons/character/Rigging/Robin/robin_extras.mb', parent='MODEL')
...
#rCtrlIO.write_ctrls("/groups/dungeons/character/Rigging/Robin/Controls", force=True, name='robin_control_curves')

#rWeightIO.write_skin("/groups/dungeons/character/Rigging/Robin/Skin", force=True, name='robin_skin_weights')
print("Reading skin weight files...")
rWeightIO.read_skin("/groups/dungeons/character/Rigging/Robin/Skin", weights_file='robin_skin_weights')
import rjg.robin_clothes as rc
reload(rc)
