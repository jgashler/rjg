...
def run():
    ...
    rWeightNgIO.read_skin(body_mesh, groups + '/dungeons/character/Rigging/Rigs/Robin/Skin', 'robin_skinning_file') 
    ...
    reload(rFaceProj)
    rFaceProj.project(body=body_mesh, char='ROOT', f_model='FaceAtOrigin', f_rig='face_M', extras='Robin_EXTRAS', f_extras='F_EXTRAS', f_skel='faceRoot_JNT')
    mc.delete(face)
