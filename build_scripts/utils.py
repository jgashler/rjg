...
# rCtrlIO.write_ctrls("/groups/dungeons/character/Rigging/Rigs/Jett/Controls", force=True, name='jett_control_curves')
# rCtrlIO.write_ctrls("/groups/dungeons/character/Rigging/Rigs/Blitz/Controls", force=True, name='blitz_control_curves')
